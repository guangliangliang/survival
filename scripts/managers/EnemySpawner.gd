...
@export var mobile_active_enemy_limit: int = 40
@export var mobile_pressure_enemy_limit: int = 32
@export var mobile_critical_enemy_limit: int = 24
@export var mobile_emergency_enemy_limit: int = 16
